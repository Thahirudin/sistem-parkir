...
if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $a = mysqli_query($koneksi, "select * from topup where id_member like '%".$cari."%'");       
  }
  else {
    $a = mysqli_query($koneksi, "select * from topup");   
  }
...
if(isset($_GET['waktu'])){
    ...
    if ($waktu == 1) {
      ...
      $a = mysqli_query($koneksi, "select * from topup where tanggal between '$tgl2' and '$tgl1' ");  
     }elseif ($waktu == 2) {
      ...
      $a = mysqli_query($koneksi, "select * from topup where tanggal = '$tgl2'");  
     }elseif ($waktu == 5) {
       $a = mysqli_query($koneksi, "select * from topup where tanggal = '$tgl1'");
     }
     else {
    $a = mysqli_query($koneksi, "select * from topup");   
    }
...
<table class="table table-hover ">
  ...
  <tbody>
    ...
    <?php endwhile;?>
     <tr>
      <th colspan="3"></th>
      <th style="border-right: solid 2px; text-align: center; " >Total :</th>
