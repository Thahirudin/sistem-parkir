...
<form action="" method="post" class="data table-responsive">
 <a href="tambah.php" class="aksi">Tambah Member</a>
<table class="table table-hover ">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> 
                <a href="topup.php?id_member=<?= $row ["id_member"] ?>" class="aksi">Topup</a> | <a href="edit.php?id_member=<?= $row ["id_member"] ?>" class="aksi">edit</a>
            </td>
    </tr>
    <?php $i++ ;?>
    <?php endwhile;?>
