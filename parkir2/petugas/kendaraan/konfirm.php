...
if (isset($_POST['submit'])) {
  ...
  if (konfirm($_POST) > 0) {
    header( "location: transaksi.php?id_parkir=$id");
  }
  else {
    echo "
        <script>
...
<div class="form-floating mb-3">
  <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="id_pegawai" readonly required value="<?php echo $_SESSION['id_pegawai'] ?>">
  <label for="floatingInput" >Id Pegawai</label>
</div>
  <div class="form-floating mb-3">
  <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="id_parkir" readonly required value="<?php echo $row ["id_parkir"]?>">
  <label for="floatingInput">Id parkir</label>
</div>
<div class="form-floating mb-3">
  <input type="date" class="form-control" id="floatingInput" placeholder="name@example.com" name="tanggal" readonly required value="<?php echo $row ["tanggal"]?>">
...
<div class="form-floating mb-3">
  <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="id_member" required value="0">
  <label for="floatingInput">id_member</label>
</div>

<?php endwhile;?>
<button type="submit" class="btn btn-success" name="submit">Total</button>
</form>
